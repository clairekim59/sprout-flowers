...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      'settings.menu': 'settings ⚙️',
      'settings.title': 'settings',
      'settings.subtitle': 'adjust your app preferences and account tools',
      'settings.profile.title': 'profile',
      'settings.profile.icon': 'change icon',
      'settings.preferences.title': 'preferences',
      'settings.language': 'language',
      'settings.language.note': 'choose the display language',
      'settings.theme': 'theme',
      'settings.theme.note': 'switch between light and dark mode',
      'settings.account.title': 'account',
      'settings.sent': 'open sent notes',
      ...
      'stage.progress.title': 'plant growth',
      'stage.progress.nextOne': '{count} 🍃 · {stage} · 1 more leaf to {next}',
      'stage.progress.nextMany': '{count} 🍃 · {stage} · {needed} more leaves to {next}',
      'stage.progress.done': '{count} 🍃 · {stage} reached',
      'stage.progress.current': 'current',
      'stage.progress.doneStatus': 'grown',
      'stage.progress.future': 'next',
      'stage.progress.rangeZero': '0 leaves',
      'stage.progress.range': '{min}-{max} leaves',
      'stage.progress.rangePlus': '{min}+ leaves',
      'stage.progress.desc.seed': 'a tiny seed begins here',
      'stage.progress.desc.sprout': 'first leaves appear',
      'stage.progress.desc.sapling': 'leafy stems stretch',
      'stage.progress.desc.bush': 'the plant fills out',
      'stage.progress.desc.blooming': 'flowers begin',
      'stage.progress.desc.flourishing': 'full bloom',
      ...
      'send.characters': '{count}/{limit} characters',
      ...
      'send.error.charLimit': 'keep your note to {limit} characters or fewer ✿',
      'send.error.full': 'this plant is already full — it has all {limit} leaves it can hold ✿',
      'send.daily.left': '{count} of {limit} notes left to send today ✿',
      'send.daily.none': 'you’ve sent all {limit} of today’s notes — come back tomorrow ♡',
    ...
    ko: {
      ...
      'settings.menu': '설정 ⚙️',
      'settings.title': '설정',
      'settings.subtitle': '앱 환경과 계정 도구를 조정해요',
      'settings.profile.title': '프로필',
      'settings.profile.icon': '아이콘 바꾸기',
      'settings.preferences.title': '환경 설정',
      'settings.language': '언어',
      'settings.language.note': '표시 언어를 선택해요',
      'settings.theme': '테마',
      'settings.theme.note': '라이트/다크 모드를 바꿔요',
      'settings.account.title': '계정',
      'settings.sent': '보낸 쪽지 열기',
      ...
      'stage.progress.title': '식물 성장 단계',
      'stage.progress.nextOne': '🍃 {count}장 · 지금은 {stage} · {next}까지 1장 남았어요',
      'stage.progress.nextMany': '🍃 {count}장 · 지금은 {stage} · {next}까지 {needed}장 남았어요',
      'stage.progress.done': '🍃 {count}장 · {stage} 단계에 도착했어요',
      'stage.progress.current': '현재',
      'stage.progress.doneStatus': '완료',
      'stage.progress.future': '다음',
      'stage.progress.rangeZero': '0장',
      'stage.progress.range': '{min}-{max}장',
      'stage.progress.rangePlus': '{min}장 이상',
      'stage.progress.desc.seed': '작은 씨앗에서 시작해요',
      'stage.progress.desc.sprout': '첫 잎이 돋아나요',
      'stage.progress.desc.sapling': '줄기와 잎이 자라요',
      'stage.progress.desc.bush': '식물이 풍성해져요',
      'stage.progress.desc.blooming': '꽃이 피기 시작해요',
      'stage.progress.desc.flourishing': '활짝 피어난 단계예요',
      ...
      'send.error.charLimit': '쪽지는 {limit}자 이하로 적어 주세요 ✿',
      'send.error.full': '이 식물은 이미 잎 {limit}장으로 가득 찼어요 ✿',
      'send.daily.left': '오늘 보낼 수 있는 쪽지 {count}/{limit}장 남았어요 ✿',
      'send.daily.none': '오늘 보낼 쪽지 {limit}장을 모두 보냈어요 — 내일 다시 와주세요 ♡',
