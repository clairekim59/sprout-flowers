...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      'garden.your': '🌷 your garden',
      'garden.loading': 'loading your garden…',
      'garden.empty': 'no sprouts here yet — invite someone above ✿',
      'garden.accept': 'accept ✿',
      'garden.decline': 'decline',
      'garden.send': 'send a note ✉',
      'garden.removeTitle': 'remove from garden',
      'garden.removeConfirm': 'remove this sprout from your garden? ✿',
      'garden.removedToast': 'removed from garden ♡',
      'garden.removeFail': 'could not remove',
      'garden.acceptToast': 'a new sprout joined your garden 🌱',
      ...
      'garden.inviteAuto': '{name} joined your garden 🌱 (they had already invited you!)',

      'leaf.from.anon': 'from someone anonymous ✿',
      'leaf.from.named': 'from {name}',
      'leaf.from.friend': 'from a friend',
      'leaf.invite.title': 'invite to garden',
      'leaf.invite.default': 'invite to my garden 💌',
      'leaf.invite.friend': 'already in your garden ✿',
      ...
      'leaf.joinedToast': '{name} joined your garden 🌱',
      ...
      'db.error.alreadyfriend': 'they’re already in your garden ✿',
    ...
    ko: {
      ...
      'garden.your': '🌷 내 정원',
      'garden.loading': '정원을 불러오는 중…',
      'garden.empty': '아직 새싹이 없어요 — 위에서 초대해 보세요 ✿',
      'garden.accept': '수락 ✿',
      'garden.decline': '거절',
      'garden.send': '쪽지 보내기 ✉',
      'garden.removeTitle': '정원에서 제거',
      'garden.removeConfirm': '이 새싹을 정원에서 제거할까요? ✿',
      'garden.removedToast': '정원에서 제거했어요 ♡',
      'garden.removeFail': '제거할 수 없어요',
      'garden.acceptToast': '새 새싹이 정원에 합류했어요 🌱',
      ...
      'garden.inviteAuto': '{name}님이 정원에 합류했어요 🌱 (이미 당신을 초대해 두었어요!)',

      'leaf.from.anon': '익명의 누군가에게서 ✿',
      'leaf.from.named': '{name}님이 보냄',
      'leaf.from.friend': '친구가 보냄',
      'leaf.invite.title': '정원에 초대',
      'leaf.invite.default': '내 정원에 초대 💌',
      'leaf.invite.friend': '이미 정원에 있어요 ✿',
      ...
      'leaf.joinedToast': '{name}님이 정원에 합류했어요 🌱',
      ...
      'db.error.alreadyfriend': '이미 정원에 있어요 ✿',
